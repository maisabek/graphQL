    ...
    ***************************************************************************** */
    ...
    var ApolloBoost = /** @class */ (function () {
        ...
        ApolloBoost.prototype.create = function (config) {
            ...
            var stateLink = config && config.clientState
                ? apolloLinkState.withClientState(__assign(__assign({}, config.clientState), { cache: cache }))
                : false;
    ...
    var ApolloBoostModule = /** @class */ (function () {
        ...
        ApolloBoostModule = __decorate([
            ...
            __param(1, core.Inject(APOLLO_BOOST_CONFIG))
        ], ApolloBoostModule);
    ...
    Object.defineProperty(exports, 'InMemoryCache', {
        enumerable: true,
        get: function () {
            return apolloCacheInmemory.InMemoryCache;
        }
    });
